...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div
        className={`hidden sm:flex items-center gap-2 bg-white shadow-xl rounded-full pl-4 pr-2 py-2 border border-gray-100 transition-all duration-300 ${
          tooltipOpen ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-4 pointer-events-none'
        }`}
      >
